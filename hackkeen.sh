...
echo "[+] Scanning with Nuclei..."
	...
	nuclei -t ~/nuclei-templates/ -silent -l ~/projects/$seed/$domain/domains/probed.txt -o ~/projects/$seed/$domain/vulnerabilities/nuclei -H X-Testing-By:user@hackerone.com
